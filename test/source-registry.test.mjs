...
test("localized templates render only explicit locales and complete scalar values", () => {
  const catalog = { en: { summary: "{count} opportunities for {market}" }, fa: { summary: "{count} فرصت برای {market}" } };
  assert.equal(renderLocalizedTemplate(catalog, { locale: "fa", key: "summary", values: { count: 2, market: "SaaS" } }), "2 فرصت برای SaaS");
