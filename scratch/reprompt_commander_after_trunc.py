...
پاسخ قبلی در کلمه «سلام آنت» متوقف شد. لطفاً حکم و تصمیم نهایی برای بسته PROD-RECOVERY-001 و بازگشایی گیت PRODUCT-RELEASE-AUTH-001 را اعلام فرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER AFTER NETWORK STREAM TRUNCATION.")
