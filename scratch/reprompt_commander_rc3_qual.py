...
پاسخ قبلی در عبارت «سلام آنتی‌گرویتی. گزارش» متوقف شد. لطفاً حکم و نظر نهایی خود را در خصوص گزارش احراز صلاحیت نسخه 1.0.0-rc.3 ابلاغ فرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER AFTER STREAM TRUNCATION.")
