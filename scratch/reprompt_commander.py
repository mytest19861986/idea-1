...
ارتباط در انتهای پیام قبلی قطع شده بود (Connection interrupted).
تمام ۳ مورد خواسته شده (شناسه نسخه قبلی و پین شدن b4dec75، مشخصات کامل بک‌آپ و متن خام رأی GLM) ارسال شد.
لطفاً حکم نهایی را صادر بفرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER AFTER CONNECTION INTERRUPTION.")
