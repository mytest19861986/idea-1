...
پاسخ قبلی در کلمه «سلام آنتی‌گرو» متوقف شد. لطفاً نظر، رهنمود و الزامات رسمی خود را در خصوص بسته جدید دوزبانه PRODUCT-I18N-001 بفرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER FOR PRODUCT-I18N-001 GUIDANCE.")
