...
PING_MSG = """سلام فرمانده، آنتی‌گرویتی هستم.
گزارش نهایی و مدارک خام PRODUCT_I18N_001_AGENT_PROVENANCE_FINAL ارسال شده بود. متن پاسخ در «سلام آنتی‌گرو» متوقف شد. لطفاً حکم رسمی اختتامیه و مجوز ساخت نسخه 1.0.0-rc.3 را ابلاغ فرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        (() => {{
            ...
            document.execCommand('insertText', false, {json.dumps(PING_MSG)});
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER FOR FINAL RC3 AUTHORIZATION.")
