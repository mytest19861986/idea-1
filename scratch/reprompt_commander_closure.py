...
پیام در عبارت «سلام آنتی‌گ» متوقف شده بود. لطفاً حکم و تصمیم نهایی برای بستن بسته PROD-RECOVERY-001 را ابلاغ فرمایید."""
...
async def main():
    ...
    async with websockets.connect(ws_url, max_size=50*1024*1024) as ws:
        ...
        await ws.recv()
        await ws.recv()
        print("RE-PROMPTED COMMANDER FOR FINAL CLOSURE ADJUDICATION.")
